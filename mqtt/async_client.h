...
private:
	...
	std::list<deliveryTokenPtr> pendingDeliveryTokens_;
...
public:
	 ...
	 */
	deliveryTokenPtr get_pending_delivery_token(int msgID) const override;
	/**
	 * Returns the delivery tokens for any outstanding publish operations.
	 * @return delivery_token[]
	 */
	std::vector<deliveryTokenPtr> get_pending_delivery_tokens() const override;
	/**
	 ...
	 */
	deliveryTokenPtr publish(string_ref topic, const void* payload, size_t n,
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(string_ref topic, const void* payload, size_t n) override {
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(string_ref topic, binary_ref payload,
							   int qos, bool retained) override;
	/**
	 * Publishes a message to a topic on the server
	 * @param topic The topic to deliver the message to
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(string_ref topic, binary_ref payload) override {
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(string_ref topic,
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(const_message_ptr msg) override;
	/**
	 * Publishes a message to a topic on the server.
	 * @param msg the message to deliver to the server
	 * @param userContext optional object used to pass context to the
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	deliveryTokenPtr publish(const_message_ptr msg,
							   void* userContext, iaction_listener& cb) override;
	/**

...
public:
	 ...
	 */
	virtual deliveryTokenPtr get_pending_delivery_token(int msgID) const =0;
	/**
	 * Returns the delivery tokens for any outstanding publish operations.
	 * @return delivery_token[]
	 */
	virtual std::vector<deliveryTokenPtr> get_pending_delivery_tokens() const =0;
	/**
	 ...
	 */
	virtual deliveryTokenPtr publish(string_ref topic,
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	virtual deliveryTokenPtr publish(string_ref topic, binary_ref payload,
									   int qos, bool retained) =0;
	/**
	 * Publishes a message to a topic on the server.
	 * @param topic The topic to deliver the message to
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	virtual deliveryTokenPtr publish(string_ref topic, binary_ref payload) =0;
	/**
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	virtual deliveryTokenPtr publish(const_message_ptr msg) =0;
	/**
	 * Publishes a message to a topic on the server.
	 * @param msg the message to deliver to the server
	 * @param userContext optional object used to pass context to the
	 ...
	 *  	   token will be passed to callback methods if set.
	 */
	virtual deliveryTokenPtr publish(const_message_ptr msg,
									   void* userContext, iaction_listener& cb) =0;
	/**
